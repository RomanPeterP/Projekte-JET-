...
namespace FeedbackAppAP08.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(string username, string password)
        {
            ...
            {
                // Erstellen einer Liste von Claims (Ansprüchen), die dem Benutzer zugeordnet werden sollen.
                // Hier: Benutzername und Rolle ("Admin").
                var claims = new List<Claim>
                {
                    new Claim(ClaimTypes.Name, username), // Claim für den Benutzernamen (zur späteren Identifikation).
                    new Claim(ClaimTypes.Role, "Admin")   // Claim für die Rolle; ermöglicht rollenbasierte Autorisierung.
                };

                // Erstellen einer Identität (Identity) auf Basis der Claims mit dem Authentifizierungsschema "FeedbackCookieAuth".
                var identity = new ClaimsIdentity(claims, "FeedbackCookieAuth");

                // Erstellen eines ClaimsPrincipal – das Sicherheitsobjekt, das die Identität(en) eines Benutzers enthält.
                ...
                // Nach erfolgreicher Anmeldung: Weiterleitung zur Liste-Seite des "Feedback"-Controllers.
